document.querySelector(".header__switcher").addEventListener("click", function () {
  let ElementsWithLightTheme = document.querySelectorAll("[class*='theme_light']");
  if (this.checked) {
    ...
    let ElementsWithDarkTheme = document.querySelectorAll("[class*='theme_dark']");
